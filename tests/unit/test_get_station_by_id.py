...
from src.postgres.repository import


@pytest.mark.asyncio
@pytest.mark.parametrize("station_id,expected_output", [
    (1, {"station_id": 1, "station_name": "Station One", "latitude": 34.05, "longitude": -118.25}),
    (2, {"station_id": 2, "station_name": "Station Two", "latitude": 40.71, "longitude": -74.01}),
